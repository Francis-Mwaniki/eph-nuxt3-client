    ...
    >
      ...
      <div class="flex flex-wrap items-center gap-y-2 gap-x-4">
        <p class="text-sm leading-6 text-gray-900">
          <strong class="font-semibold">Ephesus 2023</strong
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 2 2"
          ...
          >Join us support our ministry by subscribing to our skiza codes.
        </p>
        <Nuxt-Link
          to="/skiza_codes"
          ...
          >subscribe now <span aria-hidden="true">&rarr;</span></Nuxt-Link
        >
      </div>
