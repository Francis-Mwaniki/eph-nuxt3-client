<template>
  <footer class="text-center bg-slate-900 text-white relative z-20">
    ...
    <div class="custom-shape-divider-top-1665386917">
      <svg
        data-name="Layer 1"
        xmlns="http://www.w3.org/2000/svg"
...
export default { components: { ToggleMode } };
</script>

<style>
.custom-shape-divider-top-1665386917 {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.custom-shape-divider-top-1665386917 svg {
  position: relative;
  display: block;
...
.custom-shape-divider-top-1665386917 .shape-fill {
  fill: #070f5a;
}
</style>
